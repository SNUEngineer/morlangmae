  ...
  function PanZoom() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onKeyDown", function (e) {
      ...
      if (mappedCoords) {
        ...
        if (e.keyCode === 32) {
          //spcae bar
          _this.keyState.spacebar = true;
          e.preventDefault();
        } else if (e.keyCode === 17) {
          //control
          _this.keyState.control = true;
        }
    ...
    _defineProperty(_assertThisInitialized(_this), "onKeyUp", function (e) {
      ...
      if (e.keyCode === 32) {
        //spcae bar
        _this.keyState.spacebar = false;
        e.preventDefault();
      } else if (e.keyCode === 17) {
        //control
        _this.keyState.control = false;
      }
