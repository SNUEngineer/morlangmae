...
import { getCompanyCollections, CollectionView, pinCollection, unpinCollection } from '../../services/collection.service';
...
export default function CompanyCollectionPageContainer(props: CompanyCollectionPageConatinerProps) {
