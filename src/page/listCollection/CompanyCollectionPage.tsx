...
export default function CompanyCollectionPage(
  props: CompanyCollectionPageProps
) {
  return (
    <div>
      ...
      <CompanyCollectionCardList
        ...
        {...(props as CollectionCardFunctions)}
      />
    </div>
  );
}
...
function CompanyCollectionCardList(props: CompanyCollectionCardListProps) {
  ...
  const serviceTypes = Array.from(
    new Set(props.companyCollections.map((data) => data.serviceType))
  );
