...
export default function ModalManager(props: ModalManagerProps) {
  return (
    <Fragment>
      {props.collectionId && <CollectionViewPageContainer collectionId={props.collectionId} hideToolbar={Boolean(props.platterId)} />}
      {
        props.platterId && (
          props.platterId === 'CREATING' ? (
            <CreatePlatterPageContainer collectionId={props.collectionId as number} />
          ) : (
