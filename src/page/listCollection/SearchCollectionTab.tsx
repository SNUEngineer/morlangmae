...
export default function SearchCollectionTab(props: SearchCollectionTabProps) {
  ...
  return (
    <div>
      <CollectionTab />
      <ServiceCollectionCardList
        serviceCollections={props.serviceCollections}
        {...functions}
      />
      <HotCollectionCardList
        hotCollections={props.hotCollections}
        {...functions}
      />
      <RecentlyViewCollectionCardList
        recentlyViewCollections={props.recentlyViewedCollections}
        {...functions}
      />
      <CompanyCollectionCardList
        companyCollections={props.companyCollections}
        viewAllCompanyCollection={props.viewAllCompanyCollection}
        {...functions}
      />
    </div>
  );
...
export function ServiceCollectionCardList(
  props: ServiceCollectionCardListProps
) {
...
export function RecentlyViewCollectionCardList(
  props: RecentlyViewCollectionCardListProps
) {
